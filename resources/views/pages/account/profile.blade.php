...
<div class="space-y-6">
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <div class="space-y-4">
            ...
            <a href="{{ route('account.settings') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition text-sm font-medium">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            @php
                                ...
                                $paymentColor = $paymentColors[$order->payment_status] ?? 'bg-gray-100 text-gray-700';
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ route('account.transactions.show', $order->id) }}" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">
                                Detail
                            </a>
                        </td>
                    </tr>
